    ...
    return (
        <section className='contact'>
            <div className='contact-container'>
                <h1 className='knowus'>Get to know us better</h1>
                <p className='knowus-p'>It is a pleasure to have you on our website. Let us know if there's an opportunity to do something together.
                </p>
